      ...
      <div className={`case-study-container`}>
        ...
        <Box pb={100}>
          <Box pb={50}>
            ...
            <Typography variant="body1" className="pb-32">
              I did a research with 70 mentees which includes people working in
              the industry seeking a job, looking for internship or in final
              year in college
            </Typography>
          </Box>
          ...
          <Box pb={50}>
            ...
            <Typography variant="body1" className="pb-32">
              ...
              direction?
              <br /> 6. What if you will be provided a mentoe who will help you
              in your journey, providing you Feedback and direction at every
              step you take. Will you be intersted in learning in this way?
        ...
        <Box pb={100}>
          ...
          <Typography variant="body1" className="pb-32">
            To test the initial requirements we just built a simple flow without
            any design criteria just to understand the challenges and did pilot
            run with almost 100 users. So the flow create was like this-
          </Typography>
        ...
        <Box pb={100}>
          <Box pb={50}>
            ...
            <Typography variant="body1" className="pb-32">
              After creating the first basic product, we have pilot run it with
              a fixed set of users and on the basis of it, I have overcome the
          ...
          <Box pb={50}>
            ...
            <Box display="flex">
              <Typography variant="body2" className="pb-24" color="textPrimary">
                Finding the correct match is really important to fulfil goal and
                understand that both the mentor and mentee are aligned in their
                expectations. Earlier this was a challenge for us when we were
                doing this match manually or randomly. Because most of the time
                in the first and second session mentee or mentor loose interest
                and trust in the process because of not finding the correct
                match therefore, we as a team developed an alogrithm to find the
                perfact match as per user’s interests and skills and show the
                mentee the match percentage. With research, I came to understand
                that experience of both the person also matters in the matching
                process therefore, I have taken that in consideration and came
                with the algorithm to find the perfect match.
              </Typography>
              <img src="/groww/1.png" />
            </Box>
          </Box>
          ...
          <Box pb={50}>
            ...
            <Box display="flex">
              <Typography variant="body2" className="pb-24" color="textPrimary">
                The other challenge I got was the communication part between the
                mentor and the mentee. Most of the time Mentor would not
                ...
                after a long time. We strugggle with this part to make
                ...
                them in a better way. So to resolve this challenge we have came
                up with series of ice breaking formats which the mentee would
                ask the mentor to make the relation stroonger and better.
              </Typography>
              <img src="/groww/2.png" />
            </Box>
          </Box>
          ...
          <Box pb={50}>
            ...
            <Box display="flex">
              <Typography variant="body2" className="pb-24" color="textPrimary">
                ...
                mentee. So, most of the time mentor creates a meeting and on the
                scheduled time mentee would not show up and vice versa. So, to
                understand why is this happening we asked the mentor and mentee
                the reason of so many misssed meetings. I came to the
                understanding that they need the calendar integration along with
                a confirmation from the other party about them joining the call
                so that they only show up if the other person has confirmed
                about the meeting.
              </Typography>
              <img src="/groww/3.png" />
            </Box>
          ...
          <Box pb={50}>
            ...
            <Box display="flex">
              <Typography variant="body2" className="pb-24" color="textPrimary">
                ...
                progress so that they are disciplined and determined to achieve
                the goal. As the goal is a long time committment and most of the
                working employees give up in between working of the goal. So to
                motivate them and to keep them going it was really important to
                provide them rea time progress of their time work and
                investment. So, after a lot of research and understanding we
                divided the goals into tasks and tasks into skills and we
                provide them the graph of the progress on the basis of how they
                are performing in their respective tasks. There were a lot of
                discussions on the rating as well, wheather it should be a star
                based rating or points based out of 10 and I tend to understand
                that the mentees were mor intersted in incresing their star
                rating instead of their number grade therefore the system was
                star rating based.
              </Typography>
              <img src="/groww/4.png" />
            </Box>
          ...
          <Box pb={50}>
            ...
            <Box display="flex">
              <Typography variant="body2" className="pb-24" color="textPrimary">
                So, the next challenge they came across is to add the notes and
                managing them so the next time the mentee and mentor want to
                take note of, it should be organised in a way that there is ease
                in using and accessing the notes. Also we get to know that most
                of the notes are sometimes from the chat which the user has to
                take a lot of effor to copy and paste the messages in the notes.
                So we came up with feature of add ing the message to notes at
                double tap of the message. It helps the user to arrange and add
                the notes easily.
              </Typography>
              <img src="/groww/5.png" />
            </Box>
          ...
          <Box pb={50}>
            ...
            <Box display="flex">
              <Typography variant="body2" className="pb-24" color="textPrimary">
                ...
                this goal a habit for the user. So below are a few techniques to
                make the user feel engaged - 1) Rewards for mentee. 2)?
